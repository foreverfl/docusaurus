---
id: react
description: MDX 덕분에 Docusaurus Markdown 문서에서 React의 강점을 활용하기
...
MDX 파일 내에서 사용자 정의 컴포넌트를 정의하려면 내보내기를 해야 합니다. `export`로 시작하는 단락만 일반 텍스트 대신 컴포넌트로 파싱됩니다.
...
Docusaurus v3는 다음 옵션을 통해 덜 엄격하고 표준 [CommonMark](https://commonmark.org/) 지원을 사용할 수 있는 선택적으로 활성화 할 수 있습니다:
